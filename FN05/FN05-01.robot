...
กดปุ่ม
    ...
    Click Button           ${btn} 
***Test Cases***
TC-PSF-05-01-01 ตรวจสอบการกรอกข้อมูลช่องค้นหาจากชื่อ 
    เปิดหน้าจอ     ${url} 
    กรอกข้อมูล     ${txt_search}            ${search1} 
    กดปุ่ม         ${btn_search}
TC-PSF-05-01-02 ตรวจสอบการกรอกข้อมูลช่องค้นหาจากนามสกุล
    เปิดหน้าจอ     ${url} 
    กรอกข้อมูล     ${txt_search}            ${search2} 
    กดปุ่ม         ${btn_search}
TC-PSF-05-01-03 ตรวจสอบการกรอกข้อมูลช่องค้นหาจากรหัสนิสิต
    เปิดหน้าจอ     ${url} 
    กรอกข้อมูล     ${txt_search}            ${search3} 
    กดปุ่ม         ${btn_search}
TC-PSF-05-01-04 ตรวจสอบการกรอกข้อมูลค้นหา รับไม่เกิน 50 ตัวอักษร
    เปิดหน้าจอ     ${url} 
