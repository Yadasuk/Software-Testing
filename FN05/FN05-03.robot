...
กดปุ่ม
    [Documentation]        กดปุ่มเข้าสู่ระบบและเปิดหน้าติดตามนิสิตรอการพินิจ
    Click Button           ${btn_ok} 
...
***Test Cases***
TC-PSF-05-03-01 ตรวจสอบการแสดงผลข้อมูลรายชื่อผู้ใช้งานสถานะอาจารย์
    เปิดหน้าจอ     ${url} 
    กรอกข้อมูล     ${txt_email}       ${user1}
    กรอกข้อมูล     ${txt_pass}       ${pass1}
    กดปุ่ม
    ตรวจสอบสถานะ  ${teacher}
TC-PSF-05-03-02 ตรวจสอบการแสดงผลข้อมูลรายชื่อผู้ใช้งานสถานะเจ้าหน้าที่
    เปิดหน้าจอ     ${url} 
